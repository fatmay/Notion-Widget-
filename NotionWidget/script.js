/*function updateTime() {
    ...
    // Analog saat i�in a��lar� hesapla
...
// Sayfa y�klendi�inde bir kere �al��t�r
updateTime();
...
// Dijital ve analog saat aras�nda ge�i� yap
document.getElementById('toggleMode').addEventListener('click', function () {
    ...
    if (digitalClock.style.display === 'block') {
        ...
        toggleButton.textContent = 'Dijital Saate Ge�';
    } else {
        digitalClock.style.display = 'block';
        analogClock.style.display = 'none';
        toggleButton.textContent = 'Analog Saate Ge�';
    }
});*/
